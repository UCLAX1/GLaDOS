...
def transcribed_text_handler(
    ...
    # current_post_speech_silence_duration: mp.Value,
):
...
def vad_worker(
    ...
    min_speech_duration_for_transcription: float,
    enable_early_transcription: bool,
    should_keep_queue: mp.Queue,
    audio_to_final_transcribe_queue: mp.Queue,
    enable_realtime_transcription: bool,
    audio_to_realtime_transcribe_queue: mp.Queue,
    ...
    try:
        while not stop_event.is_set():
            ...
            if (not vad_detects_speech) and is_speaking.value:
                ...
                if elapsed_silence > current_post_speech_silence_duration.value:
...
class Recorder():
    ...
    def __init__(
        ...
        param: min_speech_duration_for_transcription:
            Minimum seconds of speech for it to be considered valid for transcription. 
            This is to prevent it trying to transcribe speech that's too short and hallucinating up "Thank you."
        param: language:
            ex: "en"
        ...
        self.current_post_speech_silence_duration = mp.Value('d', post_speech_silence_duration) # time to wait after speaking first not detected, in seconds
        ...
        self.vad_process = mp.Process(
            ...
            args=(
                ...
                self.SAMPLE_RATE,
                self.current_post_speech_silence_duration,
